...
#
    ...
    def test_11_add_qos(self):
        ...
        self.assertEquals(rule.bw_min_goal_kb, qos['bwMinGoalKB'])
        self.assertEquals(rule.bw_max_limit_kb, qos['bwMaxLimitKB'])
    ...
    def test_12_modify_qos(self):
        ...
        self.assertIsNotNone(rule)
        self.assertEquals(rule.bw_min_goal_kb, qos_after['bwMinGoalKB'])
        self.assertEquals(rule.bw_max_limit_kb, qos_after['bwMaxLimitKB'])
    ...
    def test_20_create_vvset_snapshot_no_optional(self):
        ...
        self.assertEqual(VOLUME_NAME1, snapshot.copy_of)
    ...
    def test_21_synchronize_remote_copy_group(self):
        ...
        #optional = {'targetName': 'synch_target'}
