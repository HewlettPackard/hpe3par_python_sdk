...
from hpe3par_sdk.models import RemoteCopyInfo
from hpe3par_sdk.models import RemoteCopyGroup
from hpe3par_sdk.models import Volumes
...
volume_name, lunid, hostname or port")
    ...
    def isScheduleActive(self, schedule_name):
        """
