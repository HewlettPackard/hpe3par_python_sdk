...
volume_name, lunid, hostname or port")
    ...
    def admitRemoteCopyTarget(self, targetName, mode, remoteCopyGroupName, sourceTargetVolumePairsList=[]):
        """
        ...
        :param remoteCopyGroupName : Remote copy group name
        :type remoteCopyGroupName : str
        :param sourceTargetVolumePairsList : list of pairs of primary and remote copy volumes
        :type sourceTargetVolumePairsList : list
        """
        return self.client.admitRemoteCopyTarget(targetName, mode, remoteCopyGroupName, sourceTargetVolumePairsList)
